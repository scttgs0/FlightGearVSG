...
struct Frustum {
    Frustum(const double& aspectRatio = 1) : _left(-aspectRatio),
                                             _right(aspectRatio),
                                             _bottom(-1),
                                             _top(1),
                                             _near(2)
    ...
    Frustum(const double& left, const double& right, const double& bottom, const double& top, const double& zNear) : _left(left),
                                                                                                                     _right(right),
                                                                                                                     _bottom(bottom),
                                                                                                                     _top(top),
                                                                                                                     _near(zNear)
    ...
    Frustum(const Frustum& frustum) : _left(frustum._left),
