...
SlaveCamera::SlaveCamera(const std::string& name) : _name(name),
...
bool SlaveCamera::setDrawableName(const std::string& drawableName)
{
    if (_camera.valid())
        return false;
...
bool SlaveCamera::setViewport(const SGVec4i& viewport)
{
...
bool SlaveCamera::setViewOffset(const osg::Matrix& viewOffset)
{
    _viewOffset = viewOffset;
    return true;
}

bool SlaveCamera::setViewOffsetDeg(double headingDeg, double pitchDeg, double rollDeg)
{
...
bool SlaveCamera::setFrustum(const Frustum& frustum)
{
    _frustum = frustum;
    return true;
}

void SlaveCamera::setFustumByFieldOfViewDeg(double fieldOfViewDeg)
{
...
bool SlaveCamera::setRelativeFrustum(const std::string names[2], const SlaveCamera& referenceCameraData,
...
void SlaveCamera::setProjectionReferencePoint(const std::string& name, const osg::Vec2& point)
{
...
void SlaveCamera::setMonitorProjectionReferences(double width, double height,
...
bool SlaveCamera::realize(Viewer& viewer)
{
    if (_camera.valid())
        return false;
...
bool SlaveCamera::update(Viewer& viewer)
{
...
bool SlaveCamera::_updateImplementation(Viewer& viewer)
{
    if (!_camera.valid())
        return false;
    return true;
